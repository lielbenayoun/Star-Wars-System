...
public abstract class MicroService implements Runnable {
    ...
    private HashMap<Class<? extends Message>, Callback> callBacksMaps = new HashMap<>();
    private String name;
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        callBacksMaps.put(type, callback);
    ...
    public final void run() {
        try {
            ...
            while (!terminated) { //until the current service terminate , keep sending message to and from it
                Message message = messageBus.awaitMessage(this);
                Callback callback = callBacksMaps.get(message.getClass());
    ...
    protected abstract void close() throws InterruptedException;
}
